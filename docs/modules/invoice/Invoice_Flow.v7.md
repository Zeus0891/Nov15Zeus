# 📊 INVOICE Module - Complete Flow Documentation v7.0

**Version:** 7.0  
**Last Updated:** November 16, 2025  
**Aligned with:** Invoice_Architecture_invoice.v7.md  
...
FROM Invoice i
JOIN Account a ON i.crmAccountId = a.id
WHERE 
  i.tenantId = :tenantId
  AND i.amountDue > 0
...
- ✅ **crmcore.prisma** - Customer data (Account, Contact, Address)
